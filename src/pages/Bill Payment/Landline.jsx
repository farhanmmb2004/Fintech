  ...
  <Layout>
    <div className="p-4 space-y-6">
      <div className="bg-white dark:bg-gray-800 p-6 rounded shadow-sm dark:shadow-gray-700/30 max-w-xl">
        <h1 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-100">Landline</h1>
        ...
        >
          <option value="" className="dark:bg-gray-700">-- Select Landline Provider --</option>
          <option value="BSNL" className="dark:bg-gray-700">BSNL</option>
